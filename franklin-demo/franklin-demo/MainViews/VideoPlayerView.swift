...
struct VideoPlayerView: View {
    ...
    var body: some View {
        PlayerContainerView(url: URL(string: urlString)!)
    }
}

struct VideoPlayerView_Previews: PreviewProvider {
    static var previews: some View {
        VideoPlayerView(urlString: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4")
    }
}
